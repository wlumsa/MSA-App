  ...
  return (
    <View className='flex flex-col w-full shadow-md shadow-slate-200 justify-between bg-foreground rounded-xl px-4 py-2'>
      ...
      <View className='flex flex-col justify-between w-full py-2 font-bold'>
        ...
        <View className='py-2 '>
          <Text className="text-md textGray">Category: {category}</Text>
          <Text className="text-md textGray">Method: {method}</Text>
          <Text className="text-md textGray">Location: {location}</Text>
        </View>
