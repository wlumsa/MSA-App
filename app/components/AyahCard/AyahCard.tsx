...
const AyahCard = () => {
  ...
  if (isLoading) return (
    <View className='flex flex-col rounded-xl my-4 justify-start text-start bg-foreground shadow-md shadow-slate-200 p-6 w-full'>
      <Text className="card-title text-primary text-left pb-2" style={{ fontFamily: 'LibreBaskerville-Bold', fontSize: 20 }}>
          Daily Reminder
        </Text>
  ...
  if (error) return (
    ...
    <Text className="card-title text-[#2E046D] text-left pb-2" style={{ fontFamily: 'LibreBaskerville-Bold', fontSize: 20 }}>
        Daily Reminder
      </Text>
  ...
  return (
    <View className="flex flex-col rounded-xl my-4 justify-start text-start bg-foreground shadow-md shadow-slate-200 p-6 w-full ">
        ...
        <Text className="card-text text-textPrimary py-2 justify-end " style={{ fontFamily: 'Inter', fontSize: 18, lineHeight: 28 }}>
          {ayah.arabic}
        </Text>
        <Text className="card-text text-textPrimary py-2 justify-end " style={{ fontFamily: 'Inter', fontSize: 16, lineHeight: 24 }}>
        {ayah.english}         </Text>
         <Text className="card-text text-gray-400 pt-2" style={{ fontFamily: 'Inter', fontSize: 14, fontStyle: 'italic' }}>
         {ayah.reference}
         </Text>
      </View>
  )
